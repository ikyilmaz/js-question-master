...
describe('move', () => {
  ...
  it('throws error if given source is not found', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '21', '1')).toThrow('The source is not found');
  });

  it('throws error if given destination is not found', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '2', '21')).toThrow('The destination is not found');
  });
});
